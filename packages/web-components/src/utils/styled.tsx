...
type StyledTagCreator = {
  [Tag in keyof JSX.HTMLElementTags]: (params: StyleDefinedParams) => Component<JSX.HTMLElementTags[Tag]>;
}
 ...
 */
export const styled = (
  <Props extends StylesProps, Tag extends keyof JSX.HTMLElementTags>(
    ...
    const StyledComponent: Component<CombineProps> = ((props: CombineProps) => {
      ...
      const style = (): JSX.CSSProperties | string | undefined => {
        ...
        else if (typeof propsStyle === 'object' && typeof params.style === 'object') {
          return {
            ...params.style,
            ...propsStyle,
          }
