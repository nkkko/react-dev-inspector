...
Check their documentions link for details.


## How It Works

Here shows the working pipeline of react-dev-inspector:

<Image
  className='relative my-2 sm:my-4 lg:my-6 bg-white rounded-lg shadow-xl'
  src={workingPipeline}
...
The compiler's `plugin` records source info into React components during development stage.
