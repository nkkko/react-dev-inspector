    ...
    <div className='home-content'>
      <div className='content-container'>
        ...
        <p className='subtitle'>
          ...
          with everything you love from <Link className={styles.nextjsLink} href='https://nextjs.org'>Next.js</Link>.
        </p>
        <p className='subtitle'>
          ...
          <Features>
            ...
            <Feature index={1} centered className='card-with-border' href='/docs/guide/image'>
              <div className='h-full flex flex-col justify-between'>
                ...
                <p className='text-left mb-8'>Nextra automatically converts Markdown links and images to use <Link href='https://nextjs.org/docs/routing/introduction#linking-between-pages'>Next.js Link</Link> and <Link href='https://nextjs.org/docs/basic-features/image-optimization#local-images'>Next.js Image</Link> when possible. No slow navigation or layout shift.</p>
                <div>
            ...
            <Feature
              ...
              <p
                ...
                }}><a href='https://mdxjs.com/blog/v2' target='_blank' style={{ color: 'currentColor' }} rel='noreferrer'>MDX 2</a> lets you use Components inside Markdown, <br className='hide-medium' />with huge performance boost since v1.</p>
            </Feature>
            <Feature
              index={5}
              centered
